...
export default function ServiceRetentionAgreementPage() {
  return (
    <AuthLayout scroll blurb="VersaLife Health for doctors. The terms that govern how consultation fees are retained and paid.">
      <div className="flex w-full flex-col gap-6">
        <AuthHeading
          title="Service retention agreement"
          subtitle="Please read this agreement before you apply to practise on VersaLife Health."
        />

        <div className="flex max-w-prose flex-col gap-4 text-body text-muted">
          <p>
          ...
          <h2 className="mt-2 text-h5 text-ink">1. Parties</h2>
          <p>
          ...
          <h2 className="mt-2 text-h5 text-ink">2. Retention of service fees</h2>
          <p>
          ...
          <h2 className="mt-2 text-h5 text-ink">3. Your consultation fee</h2>
          <p>
          ...
          <h2 className="mt-2 text-h5 text-ink">4. Payouts</h2>
          <p>
          ...
          <h2 className="mt-2 text-h5 text-ink">5. Professional obligations</h2>
          <p>
          ...
          <h2 className="mt-2 text-h5 text-ink">6. Records and privacy</h2>
          <p>
          ...
          <h2 className="mt-2 text-h5 text-ink">7. Ending the agreement</h2>
          <p>
        ...
        <Link href="/register" className="font-semibold text-brand underline-offset-4 can-hover:hover:underline">
