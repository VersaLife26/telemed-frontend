...
import DoctorPage from "@/components/consumer/pages/doctor__register";
import PatientPage from "@/components/consumer/pages/patient__register";

/**
 * /register -- served by doctor, patient.
 *
