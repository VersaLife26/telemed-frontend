...
import AdminPage from "@/components/admin/pages/admin__doctors";
import PatientPage from "@/components/consumer/pages/patient__doctors";

/**
 * /doctors -- served by admin, patient.
 *
...
export const metadata: Metadata =
  SURFACE === "admin" ? { title: "Verification queue" } : {};

export default async function Page({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  if (SURFACE === "admin") return <AdminPage searchParams={searchParams} />;
  return <PatientPage searchParams={searchParams} />;
}
