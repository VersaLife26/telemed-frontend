 ...
 *
 * A real <table> with a real <caption>, not a grid of divs. Screen readers get
 * row and column counts, "column 3 of 7" announcements and header association
 * for free — none of which a div soup provides, and all of which an admin
 * auditing a payment ledger by keyboard depends on.
 */
